...
.imgfig figcaption{font-family:var(--serif);font-style:italic;font-size:14.5px;
  color:var(--soft);margin-top:20px;line-height:1.4;}
...
/* Provenance tag in a scorecard row: says whether a number was generated, read or computed.
...
@media (max-width:920px){
  ...
  body{font-size:17px;}
  .imgfig.wide{width:auto;max-width:100%;padding:20px 18px 8px;margin-left:0;margin-right:0;}
}
