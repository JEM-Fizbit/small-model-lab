...
<text x="167" y="240" text-anchor="middle" font-size="10.5" fill="#6e6557" font-family="ui-monospace,Menlo,monospace">#5381</text>
...
<text x="317" y="240" text-anchor="middle" font-size="10.5" fill="#6e6557" font-family="ui-monospace,Menlo,monospace">#284</text>
...
<text x="435" y="240" text-anchor="middle" font-size="10.5" fill="#6e6557" font-family="ui-monospace,Menlo,monospace">#103</text>
...
<text x="553" y="240" text-anchor="middle" font-size="10.5" fill="#6e6557" font-family="ui-monospace,Menlo,monospace">#240</text>
...
PROBS_SVG = r'''<svg viewBox="0 0 720 286" role="img" aria-label="The model's real next-word scores for the prompt One day, Lily went to the: park 68 percent, store 10 percent, then small scores, with about 14 percent spread over all other chunks.">
...
<text x="616" y="79" font-size="11" fill="#6e6557" font-family="ui-monospace,Menlo,monospace">68.1%</text>
<text x="218" y="109" text-anchor="end" font-size="12" font-family="ui-monospace,Menlo,monospace" fill="#231f18"> store</text>
<rect x="228" y="94" width="57" height="21" rx="4" fill="#963d2c"/>
<text x="293" y="109" font-size="11" fill="#6e6557" font-family="ui-monospace,Menlo,monospace">10.3%</text>
<text x="218" y="139" text-anchor="end" font-size="12" font-family="ui-monospace,Menlo,monospace" fill="#231f18"> beach</text>
<rect x="228" y="124" width="22" height="21" rx="4" fill="#963d2c"/>
<text x="258" y="139" font-size="11" fill="#6e6557" font-family="ui-monospace,Menlo,monospace">4.0%</text>
<text x="218" y="169" text-anchor="end" font-size="12" font-family="ui-monospace,Menlo,monospace" fill="#231f18"> zoo</text>
<rect x="228" y="154" width="12" height="21" rx="4" fill="#963d2c"/>
<text x="248" y="169" font-size="11" fill="#6e6557" font-family="ui-monospace,Menlo,monospace">2.1%</text>
<text x="218" y="199" text-anchor="end" font-size="12" font-family="ui-monospace,Menlo,monospace" fill="#231f18"> river</text>
<rect x="228" y="184" width="6" height="21" rx="4" fill="#963d2c"/>
<text x="242" y="199" font-size="11" fill="#6e6557" font-family="ui-monospace,Menlo,monospace">1.0%</text>
<text x="218" y="229" text-anchor="end" font-size="12" font-style="italic" fill="#6e6557">everything else (~8,000 chunks)</text>
<rect x="228" y="214" width="81" height="21" rx="4" fill="#cfc5ae"/>
<text x="317" y="229" font-size="11" fill="#6e6557" font-family="ui-monospace,Menlo,monospace">14.5%</text>
...
ATTENTION_SVG = r'''<svg viewBox="0 0 720 312" role="img" aria-label="Attention, measured: arcs from the word it back to earlier words in the sentence The dragon looked at the boy and it. The arc to dragon carries 43 percent of the attention; smaller arcs go to looked (15 percent), boy (5 percent), and (5 percent), The (4 percent), at (1 percent); it keeps 27 percent for itself.">
...
<path d="M 581 204 Q 362 -25 144 204" fill="none" stroke="#963d2c" stroke-width="1.6" opacity="0.4"/>
<text x="362" y="80" text-anchor="middle" font-size="10" font-weight="400" fill="#963d2c">4%</text>
<path d="M 581 204 Q 398 1 215 204" fill="none" stroke="#b0402a" stroke-width="5.5" opacity="0.84"/>
<text x="398" y="94" text-anchor="middle" font-size="11" font-weight="700" fill="#b0402a">43%</text>
<path d="M 581 204 Q 441 32 301 204" fill="none" stroke="#963d2c" stroke-width="2.7" opacity="0.45"/>
<text x="480" y="115" text-anchor="middle" font-size="10" font-weight="400" fill="#963d2c">15%</text>
<path d="M 581 204 Q 474 55 367 204" fill="none" stroke="#963d2c" stroke-width="1.3" opacity="0.36"/>
<text x="429" y="133" text-anchor="middle" font-size="10" font-weight="400" fill="#963d2c">1%</text>
<path d="M 581 204 Q 527 94 474 204" fill="none" stroke="#963d2c" stroke-width="1.7" opacity="0.36"/>
<text x="527" y="139" text-anchor="middle" font-size="10" font-weight="400" fill="#963d2c">5%</text>
<path d="M 581 204 Q 555 114 530 204" fill="none" stroke="#963d2c" stroke-width="1.7" opacity="0.39"/>
<text x="555" y="149" text-anchor="middle" font-size="10" font-weight="400" fill="#963d2c">5%</text>
...
<text x="581" y="260" text-anchor="middle" font-size="9.5" fill="#8c6a2a">the token asking (its “query”) — keeps 27% for itself</text>
<text x="215" y="260" text-anchor="middle" font-size="9.5" fill="#8d4257">the best-matching “key”</text>
<text x="30" y="292" font-size="10.5" fill="#6e6557">“the” get ≈0%. This head has learned to track who the sentence is about; other heads in the same</text>
...
TEMP_SVG = r'''<svg viewBox="0 0 720 320" role="img" aria-label="The same real next-word scores for Tom was very, sampled at temperature 0.5 and 1.1. At 0.5 excited dominates; at 1.1 nearly half the probability spreads to the long tail of other chunks.">
...
<text x="148" y="96" text-anchor="end" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="#231f18"> excited</text>
<rect x="156" y="82" width="79" height="19" rx="4" fill="#5f6c33"/>
<text x="242" y="96" font-size="10.5" fill="#6e6557" font-family="ui-monospace,Menlo,monospace">32.8%</text>
<text x="148" y="124" text-anchor="end" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="#231f18"> happy</text>
<rect x="156" y="110" width="64" height="19" rx="4" fill="#5f6c33"/>
<text x="227" y="124" font-size="10.5" fill="#6e6557" font-family="ui-monospace,Menlo,monospace">26.6%</text>
<text x="148" y="152" text-anchor="end" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="#231f18"> sad</text>
<rect x="156" y="138" width="52" height="19" rx="4" fill="#5f6c33"/>
<text x="215" y="152" font-size="10.5" fill="#6e6557" font-family="ui-monospace,Menlo,monospace">21.3%</text>
<text x="148" y="180" text-anchor="end" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="#231f18"> scared</text>
<rect x="156" y="166" width="13" height="19" rx="4" fill="#5f6c33"/>
<text x="176" y="180" font-size="10.5" fill="#6e6557" font-family="ui-monospace,Menlo,monospace">5.2%</text>
<text x="148" y="208" text-anchor="end" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="#231f18"> proud</text>
<rect x="156" y="194" width="7" height="19" rx="4" fill="#5f6c33"/>
<text x="170" y="208" font-size="10.5" fill="#6e6557" font-family="ui-monospace,Menlo,monospace">2.9%</text>
<text x="148" y="236" text-anchor="end" font-size="11.5" font-style="italic" fill="#6e6557">everything else</text>
<rect x="156" y="222" width="27" height="19" rx="4" fill="#cfc5ae"/>
<text x="190" y="236" font-size="10.5" fill="#6e6557" font-family="ui-monospace,Menlo,monospace">11.2%</text>
<text x="532" y="68" text-anchor="middle" font-size="12" font-weight="700" fill="#8c6a2a">temperature 1.1 — adventurous</text>
<text x="493" y="96" text-anchor="end" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="#231f18"> excited</text>
<rect x="501" y="82" width="26" height="19" rx="4" fill="#8c6a2a"/>
<text x="534" y="96" font-size="10.5" fill="#6e6557" font-family="ui-monospace,Menlo,monospace">10.9%</text>
<text x="493" y="124" text-anchor="end" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="#231f18"> happy</text>
<rect x="501" y="110" width="24" height="19" rx="4" fill="#8c6a2a"/>
<text x="532" y="124" font-size="10.5" fill="#6e6557" font-family="ui-monospace,Menlo,monospace">9.9%</text>
<text x="493" y="152" text-anchor="end" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="#231f18"> sad</text>
<rect x="501" y="138" width="22" height="19" rx="4" fill="#8c6a2a"/>
<text x="530" y="152" font-size="10.5" fill="#6e6557" font-family="ui-monospace,Menlo,monospace">8.9%</text>
<text x="493" y="180" text-anchor="end" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="#231f18"> scared</text>
<rect x="501" y="166" width="11" height="19" rx="4" fill="#8c6a2a"/>
<text x="519" y="180" font-size="10.5" fill="#6e6557" font-family="ui-monospace,Menlo,monospace">4.7%</text>
<text x="493" y="208" text-anchor="end" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="#231f18"> proud</text>
<rect x="501" y="194" width="9" height="19" rx="4" fill="#8c6a2a"/>
<text x="517" y="208" font-size="10.5" fill="#6e6557" font-family="ui-monospace,Menlo,monospace">3.6%</text>
<text x="493" y="236" text-anchor="end" font-size="11.5" font-style="italic" fill="#6e6557">everything else</text>
<rect x="501" y="222" width="150" height="19" rx="4" fill="#cfc5ae"/>
<text x="658" y="236" font-size="10.5" fill="#6e6557" font-family="ui-monospace,Menlo,monospace">62.0%</text>
<text x="660" y="265" text-anchor="end" font-size="10" fill="#8c6a2a" font-style="italic">↑ the long tail gets a real chance</text>
<text x="30" y="294" font-size="10.5" fill="#6e6557">Temperature reshapes how the menu is sampled, not the menu itself: at 0.5, “excited” wins ~33% of draws; at 1.1, nearly half</text>
...
WE_MATRIX_SVG = r'''<svg viewBox="0 0 702 568" role="img" aria-label="The embedding matrix W_E of the trained Track A model: 8192 token columns (real tokens, alphabetical) by 384 dimension rows; each cell a real signed learned value, red positive, blue negative.">
<path d="M 102 72 q 0 -12 12 -12 L 355.0 60 q 14 0 14 -12 q 0 12 14 12 L 624 60 q 12 0 12 12" fill="none" stroke="#6e6557" stroke-width="1.4"/>
<text x="369.0" y="46" text-anchor="middle" font-size="15" font-family="Charter,'Iowan Old Style',Georgia,serif" fill="#231f18">All tokens, <tspan font-style="italic">~8k</tspan></text>
<text x="117.0" y="131" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="#231f18" transform="rotate(-50 117.0 131)">Abbie</text>
<text x="117.0" y="147" text-anchor="middle" font-size="11" font-family="ui-monospace,Menlo,monospace" fill="#998f7d">#6170</text>
<text x="159.0" y="131" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="#231f18" transform="rotate(-50 159.0 131)">Abby</text>
<text x="159.0" y="147" text-anchor="middle" font-size="11" font-family="ui-monospace,Menlo,monospace" fill="#998f7d">#7079</text>
<text x="201.0" y="131" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="#231f18" transform="rotate(-50 201.0 131)">Abi</text>
<text x="201.0" y="147" text-anchor="middle" font-size="11" font-family="ui-monospace,Menlo,monospace" fill="#998f7d">#6567</text>
<text x="243.0" y="131" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="#231f18" transform="rotate(-50 243.0 131)">Abigail</text>
<text x="243.0" y="147" text-anchor="middle" font-size="11" font-family="ui-monospace,Menlo,monospace" fill="#998f7d">#4964</text>
<text x="285.0" y="131" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="#231f18" transform="rotate(-50 285.0 131)">able</text>
<text x="285.0" y="147" text-anchor="middle" font-size="11" font-family="ui-monospace,Menlo,monospace" fill="#998f7d">#1344</text>
<text x="327.0" y="131" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="#231f18" transform="rotate(-50 327.0 131)">about</text>
<text x="327.0" y="147" text-anchor="middle" font-size="11" font-family="ui-monospace,Menlo,monospace" fill="#998f7d">#511</text>
<text x="369.0" y="131" text-anchor="middle" font-size="13" fill="#998f7d">⋯</text>
<text x="369.0" y="147" text-anchor="middle" font-size="11" fill="#998f7d">⋯</text>
<text x="411.0" y="131" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="#231f18" transform="rotate(-50 411.0 131)">zooming</text>
<text x="411.0" y="147" text-anchor="middle" font-size="11" font-family="ui-monospace,Menlo,monospace" fill="#998f7d">#5071</text>
<text x="453.0" y="131" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="#231f18" transform="rotate(-50 453.0 131)">Zoomy</text>
<text x="453.0" y="147" text-anchor="middle" font-size="11" font-family="ui-monospace,Menlo,monospace" fill="#998f7d">#6888</text>
<text x="495.0" y="131" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="#231f18" transform="rotate(-50 495.0 131)">âĢĵ</text>
<text x="495.0" y="147" text-anchor="middle" font-size="11" font-family="ui-monospace,Menlo,monospace" fill="#998f7d">#4058</text>
<text x="537.0" y="131" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="#231f18" transform="rotate(-50 537.0 131)">âĢĶ</text>
<text x="537.0" y="147" text-anchor="middle" font-size="11" font-family="ui-monospace,Menlo,monospace" fill="#998f7d">#7805</text>
<text x="579.0" y="131" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="#231f18" transform="rotate(-50 579.0 131)">âĢĺ</text>
<text x="579.0" y="147" text-anchor="middle" font-size="11" font-family="ui-monospace,Menlo,monospace" fill="#998f7d">#6044</text>
<text x="621.0" y="131" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="#231f18" transform="rotate(-50 621.0 131)">âĢľ</text>
<text x="621.0" y="147" text-anchor="middle" font-size="11" font-family="ui-monospace,Menlo,monospace" fill="#998f7d">#798</text>
<text x="86" y="147" text-anchor="end" font-size="9.5" font-family="Charter,'Iowan Old Style',Georgia,serif" fill="#6e6557">token id →</text>
<line x1="88" y1="153" x2="650" y2="153" stroke="#ddd4c2" stroke-width="0.9"/>
<path d="M 96 156 L 88 156 L 88 498 L 96 498" fill="none" stroke="#231f18" stroke-width="2.2"/>
<path d="M 642 156 L 650 156 L 650 498 L 642 498" fill="none" stroke="#231f18" stroke-width="2.2"/>
<text x="46" y="329.0" text-anchor="middle" font-size="24" font-family="Charter,'Iowan Old Style',Georgia,serif" font-style="italic" fill="#231f18">W<tspan font-size="16" dy="6">E</tspan><tspan font-size="24" dy="-6" font-style="normal"> =</tspan></text>
<text x="117.0" y="175.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(167,84,70)">+0.04</text>
<text x="117.0" y="201.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(154,143,121)">+0.00</text>
<text x="117.0" y="227.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(138,135,128)">−0.01</text>
<text x="117.0" y="253.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(91,110,148)">−0.04</text>
<text x="117.0" y="279.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(176,39,31)">+0.07</text>
<text x="117.0" y="305.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(138,135,128)">−0.01</text>
<text x="117.0" y="331.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(138,135,128)">−0.01</text>
<text x="117.0" y="357.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(122,127,134)">−0.02</text>
<text x="117.0" y="383.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(75,102,155)">−0.05</text>
<text x="117.0" y="409.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(167,84,70)">+0.04</text>
<text x="117.0" y="435.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(160,113,95)">+0.02</text>
<text x="117.0" y="461.0" text-anchor="middle" font-size="13" fill="#998f7d">⋮</text>
<text x="117.0" y="487.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(59,94,161)">−0.06</text>
<text x="159.0" y="175.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(167,84,70)">+0.04</text>
<text x="159.0" y="201.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(122,127,134)">−0.02</text>
<text x="159.0" y="227.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(106,119,141)">−0.03</text>
<text x="159.0" y="253.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(43,86,168)">−0.07</text>
<text x="159.0" y="279.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(167,84,70)">+0.04</text>
<text x="159.0" y="305.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(106,119,141)">−0.03</text>
<text x="159.0" y="331.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(138,135,128)">−0.01</text>
<text x="159.0" y="357.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(106,119,141)">−0.03</text>
<text x="159.0" y="383.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(160,113,95)">+0.02</text>
<text x="159.0" y="409.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(160,113,95)">+0.02</text>
<text x="159.0" y="435.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(122,127,134)">−0.02</text>
<text x="159.0" y="461.0" text-anchor="middle" font-size="13" fill="#998f7d">⋮</text>
<text x="159.0" y="487.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(138,135,128)">−0.01</text>
<text x="201.0" y="175.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(167,84,70)">+0.04</text>
<text x="201.0" y="201.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(138,135,128)">−0.01</text>
<text x="201.0" y="227.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(59,94,161)">−0.06</text>
<text x="201.0" y="253.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(91,110,148)">−0.04</text>
<text x="201.0" y="279.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(167,84,70)">+0.04</text>
<text x="201.0" y="305.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(75,102,155)">−0.05</text>
<text x="201.0" y="331.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(75,102,155)">−0.05</text>
<text x="201.0" y="357.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(170,69,57)">+0.05</text>
<text x="201.0" y="383.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(160,113,95)">+0.02</text>
<text x="201.0" y="409.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(157,128,108)">+0.01</text>
<text x="201.0" y="435.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(167,84,70)">+0.04</text>
<text x="201.0" y="461.0" text-anchor="middle" font-size="13" fill="#998f7d">⋮</text>
<text x="201.0" y="487.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(170,69,57)">+0.05</text>
<text x="243.0" y="175.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(167,84,70)">+0.04</text>
<text x="243.0" y="201.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(157,128,108)">+0.01</text>
<text x="243.0" y="227.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(122,127,134)">−0.02</text>
<text x="243.0" y="253.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(91,110,148)">−0.04</text>
<text x="243.0" y="279.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(163,98,82)">+0.03</text>
<text x="243.0" y="305.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(91,110,148)">−0.04</text>
<text x="243.0" y="331.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(170,69,57)">+0.05</text>
<text x="243.0" y="357.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(122,127,134)">−0.02</text>
<text x="243.0" y="383.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(43,86,168)">−0.09</text>
<text x="243.0" y="409.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(122,127,134)">−0.02</text>
<text x="243.0" y="435.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(160,113,95)">+0.02</text>
<text x="243.0" y="461.0" text-anchor="middle" font-size="13" fill="#998f7d">⋮</text>
<text x="243.0" y="487.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(154,143,121)">+0.00</text>
<text x="285.0" y="175.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(43,86,168)">−0.07</text>
<text x="285.0" y="201.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(170,69,57)">+0.05</text>
<text x="285.0" y="227.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(154,143,121)">+0.00</text>
<text x="285.0" y="253.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(122,127,134)">−0.02</text>
<text x="285.0" y="279.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(122,127,134)">−0.02</text>
<text x="285.0" y="305.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(122,127,134)">−0.02</text>
<text x="285.0" y="331.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(43,86,168)">−0.07</text>
<text x="285.0" y="357.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(43,86,168)">−0.08</text>
<text x="285.0" y="383.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(157,128,108)">+0.01</text>
<text x="285.0" y="409.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(160,113,95)">+0.02</text>
<text x="285.0" y="435.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(91,110,148)">−0.04</text>
<text x="285.0" y="461.0" text-anchor="middle" font-size="13" fill="#998f7d">⋮</text>
<text x="285.0" y="487.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(75,102,155)">−0.05</text>
<text x="327.0" y="175.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(154,143,121)">+0.00</text>
<text x="327.0" y="201.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(154,143,121)">+0.00</text>
<text x="327.0" y="227.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(173,54,44)">+0.06</text>
<text x="327.0" y="253.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(163,98,82)">+0.03</text>
<text x="327.0" y="279.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(75,102,155)">−0.05</text>
<text x="327.0" y="305.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(138,135,128)">−0.01</text>
<text x="327.0" y="331.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(176,39,31)">+0.14</text>
<text x="327.0" y="357.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(43,86,168)">−0.09</text>
<text x="327.0" y="383.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(163,98,82)">+0.03</text>
<text x="327.0" y="409.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(59,94,161)">−0.06</text>
<text x="327.0" y="435.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(106,119,141)">−0.03</text>
<text x="327.0" y="461.0" text-anchor="middle" font-size="13" fill="#998f7d">⋮</text>
<text x="327.0" y="487.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(176,39,31)">+0.10</text>
<text x="369.0" y="175.0" text-anchor="middle" font-size="12" fill="#998f7d">⋯</text>
<text x="369.0" y="201.0" text-anchor="middle" font-size="12" fill="#998f7d">⋯</text>
<text x="369.0" y="227.0" text-anchor="middle" font-size="12" fill="#998f7d">⋯</text>
<text x="369.0" y="253.0" text-anchor="middle" font-size="12" fill="#998f7d">⋯</text>
<text x="369.0" y="279.0" text-anchor="middle" font-size="12" fill="#998f7d">⋯</text>
<text x="369.0" y="305.0" text-anchor="middle" font-size="12" fill="#998f7d">⋯</text>
<text x="369.0" y="331.0" text-anchor="middle" font-size="12" fill="#998f7d">⋯</text>
<text x="369.0" y="357.0" text-anchor="middle" font-size="12" fill="#998f7d">⋯</text>
<text x="369.0" y="383.0" text-anchor="middle" font-size="12" fill="#998f7d">⋯</text>
<text x="369.0" y="409.0" text-anchor="middle" font-size="12" fill="#998f7d">⋯</text>
<text x="369.0" y="435.0" text-anchor="middle" font-size="12" fill="#998f7d">⋯</text>
<text x="369.0" y="461.0" text-anchor="middle" font-size="13" fill="#998f7d">⋮</text>
<text x="369.0" y="487.0" text-anchor="middle" font-size="12" fill="#998f7d">⋯</text>
<text x="411.0" y="175.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(59,94,161)">−0.06</text>
<text x="411.0" y="201.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(122,127,134)">−0.02</text>
<text x="411.0" y="227.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(43,86,168)">−0.10</text>
<text x="411.0" y="253.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(160,113,95)">+0.02</text>
<text x="411.0" y="279.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(170,69,57)">+0.05</text>
<text x="411.0" y="305.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(59,94,161)">−0.06</text>
<text x="411.0" y="331.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(122,127,134)">−0.02</text>
<text x="411.0" y="357.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(173,54,44)">+0.06</text>
<text x="411.0" y="383.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(75,102,155)">−0.05</text>
<text x="411.0" y="409.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(163,98,82)">+0.03</text>
<text x="411.0" y="435.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(122,127,134)">−0.02</text>
<text x="411.0" y="461.0" text-anchor="middle" font-size="13" fill="#998f7d">⋮</text>
<text x="411.0" y="487.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(167,84,70)">+0.04</text>
<text x="453.0" y="175.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(154,143,121)">+0.00</text>
<text x="453.0" y="201.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(173,54,44)">+0.06</text>
<text x="453.0" y="227.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(91,110,148)">−0.04</text>
<text x="453.0" y="253.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(122,127,134)">−0.02</text>
<text x="453.0" y="279.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(167,84,70)">+0.04</text>
<text x="453.0" y="305.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(154,143,121)">+0.00</text>
<text x="453.0" y="331.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(167,84,70)">+0.04</text>
<text x="453.0" y="357.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(43,86,168)">−0.07</text>
<text x="453.0" y="383.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(154,143,121)">+0.00</text>
<text x="453.0" y="409.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(122,127,134)">−0.02</text>
<text x="453.0" y="435.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(157,128,108)">+0.01</text>
<text x="453.0" y="461.0" text-anchor="middle" font-size="13" fill="#998f7d">⋮</text>
<text x="453.0" y="487.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(138,135,128)">−0.01</text>
<text x="495.0" y="175.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(122,127,134)">−0.02</text>
<text x="495.0" y="201.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(170,69,57)">+0.05</text>
<text x="495.0" y="227.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(176,39,31)">+0.07</text>
<text x="495.0" y="253.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(138,135,128)">−0.01</text>
<text x="495.0" y="279.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(157,128,108)">+0.01</text>
<text x="495.0" y="305.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(106,119,141)">−0.03</text>
<text x="495.0" y="331.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(154,143,121)">+0.00</text>
<text x="495.0" y="357.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(106,119,141)">−0.03</text>
<text x="495.0" y="383.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(173,54,44)">+0.06</text>
<text x="495.0" y="409.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(170,69,57)">+0.05</text>
<text x="495.0" y="435.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(157,128,108)">+0.01</text>
<text x="495.0" y="461.0" text-anchor="middle" font-size="13" fill="#998f7d">⋮</text>
<text x="495.0" y="487.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(176,39,31)">+0.09</text>
<text x="537.0" y="175.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(157,128,108)">+0.01</text>
<text x="537.0" y="201.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(91,110,148)">−0.04</text>
<text x="537.0" y="227.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(122,127,134)">−0.02</text>
<text x="537.0" y="253.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(122,127,134)">−0.02</text>
<text x="537.0" y="279.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(160,113,95)">+0.02</text>
<text x="537.0" y="305.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(157,128,108)">+0.01</text>
<text x="537.0" y="331.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(176,39,31)">+0.09</text>
<text x="537.0" y="357.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(75,102,155)">−0.05</text>
<text x="537.0" y="383.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(154,143,121)">+0.00</text>
<text x="537.0" y="409.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(160,113,95)">+0.02</text>
<text x="537.0" y="435.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(160,113,95)">+0.02</text>
<text x="537.0" y="461.0" text-anchor="middle" font-size="13" fill="#998f7d">⋮</text>
<text x="537.0" y="487.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(154,143,121)">+0.00</text>
<text x="579.0" y="175.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(160,113,95)">+0.02</text>
<text x="579.0" y="201.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(43,86,168)">−0.08</text>
<text x="579.0" y="227.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(106,119,141)">−0.03</text>
<text x="579.0" y="253.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(154,143,121)">+0.00</text>
<text x="579.0" y="279.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(154,143,121)">+0.00</text>
<text x="579.0" y="305.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(75,102,155)">−0.05</text>
<text x="579.0" y="331.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(154,143,121)">+0.00</text>
<text x="579.0" y="357.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(170,69,57)">+0.05</text>
<text x="579.0" y="383.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(106,119,141)">−0.03</text>
<text x="579.0" y="409.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(176,39,31)">+0.08</text>
<text x="579.0" y="435.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(122,127,134)">−0.02</text>
<text x="579.0" y="461.0" text-anchor="middle" font-size="13" fill="#998f7d">⋮</text>
<text x="579.0" y="487.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(176,39,31)">+0.07</text>
<text x="621.0" y="175.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(106,119,141)">−0.03</text>
<text x="621.0" y="201.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(59,94,161)">−0.06</text>
<text x="621.0" y="227.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(106,119,141)">−0.03</text>
<text x="621.0" y="253.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(157,128,108)">+0.01</text>
<text x="621.0" y="279.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(170,69,57)">+0.05</text>
<text x="621.0" y="305.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(122,127,134)">−0.02</text>
<text x="621.0" y="331.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(138,135,128)">−0.01</text>
<text x="621.0" y="357.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(157,128,108)">+0.01</text>
<text x="621.0" y="383.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(43,86,168)">−0.09</text>
<text x="621.0" y="409.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(170,69,57)">+0.05</text>
<text x="621.0" y="435.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(157,128,108)">+0.01</text>
<text x="621.0" y="461.0" text-anchor="middle" font-size="13" fill="#998f7d">⋮</text>
<text x="621.0" y="487.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(176,39,31)">+0.08</text>
<path d="M 658 158 q 8 0 8 10 L 666 317.0 q 0 10 8 10 q -8 0 -8 10 L 666 486 q 0 10 -8 10" fill="none" stroke="#998f7d" stroke-width="1.2"/>
<text x="680" y="323.0" font-size="12" font-family="Charter,'Iowan Old Style',Georgia,serif" fill="#6e6557">384</text>
<text x="680" y="338.0" font-size="12" font-family="Charter,'Iowan Old Style',Georgia,serif" fill="#6e6557">dims</text>
<text x="369.0" y="540" text-anchor="middle" font-size="23" font-family="Charter,'Iowan Old Style',Georgia,serif" fill="#231f18">Embedding matrix</text>
<text x="96" y="558" font-size="10.5" font-family="Charter,'Iowan Old Style',Georgia,serif" fill="#6e6557">each cell is one real learned number:</text>
<text x="308" y="558" font-size="11" font-family="ui-monospace,Menlo,monospace" fill="rgb(176,39,31)">+ red</text>
<text x="364" y="558" font-size="10.5" font-family="Charter,'Iowan Old Style',Georgia,serif" fill="#6e6557">stronger positive,</text>
<text x="468" y="558" font-size="11" font-family="ui-monospace,Menlo,monospace" fill="rgb(43,86,168)">− blue</text>
<text x="524" y="558" font-size="10.5" font-family="Charter,'Iowan Old Style',Georgia,serif" fill="#6e6557">stronger negative</text>
</svg>'''
...
"""),
  ("diagram", WE_MATRIX_SVG,
   ...
   "rows</strong>, every cell a learned value (12 tokens shown, swept A&rarr;Z; &#8943; stands in for the other "
   "~8,180). Each column also carries its real <strong>token id</strong> (scrambled: the columns are "
   "alphabetical, the ids are not, per &sect;2). Each column is one token&rsquo;s vector, the "
   "&ldquo;meaning coordinates&rdquo; this section "
