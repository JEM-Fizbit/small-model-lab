...
it predicts what comes next.</strong> Not whole thoughts — the next small chunk (a <em>token</em>:
...
<strong>gradient</strong> — for every parameter, the slope of the loss: which direction, and how hard,
