...
<text x="409.0" y="131" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="#231f18" transform="rotate(-50 409.0 131)">about</text>
<text x="409.0" y="147" text-anchor="middle" font-size="9" font-family="ui-monospace,Menlo,monospace" fill="#998f7d">#517</text>
<text x="455.0" y="131" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="#231f18" transform="rotate(-50 455.0 131)">above</text>
<text x="455.0" y="147" text-anchor="middle" font-size="9" font-family="ui-monospace,Menlo,monospace" fill="#998f7d">#3058</text>
<text x="501.0" y="131" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="#231f18" transform="rotate(-50 501.0 131)">acc</text>
<text x="501.0" y="147" text-anchor="middle" font-size="9" font-family="ui-monospace,Menlo,monospace" fill="#998f7d">#1629</text>
<text x="547.0" y="131" text-anchor="middle" font-size="13" fill="#998f7d">⋯</text>
...
<text x="731.0" y="131" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="#231f18" transform="rotate(-50 731.0 131)">zookeeper</text>
<text x="731.0" y="147" text-anchor="middle" font-size="9" font-family="ui-monospace,Menlo,monospace" fill="#998f7d">#6530</text>
<text x="777.0" y="131" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="#231f18" transform="rotate(-50 777.0 131)">zoom</text>
<text x="777.0" y="147" text-anchor="middle" font-size="9" font-family="ui-monospace,Menlo,monospace" fill="#998f7d">#2040</text>
<text x="823.0" y="131" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="#231f18" transform="rotate(-50 823.0 131)">zoomed</text>
...
<path d="M 156 156 L 148 156 L 148 498 L 156 498" fill="none" stroke="#231f18" stroke-width="2.2"/>
<path d="M 938 156 L 946 156 L 946 498 L 938 498" fill="none" stroke="#231f18" stroke-width="2.2"/>
<text x="70" y="329.0" text-anchor="middle" font-size="34" font-family="Charter,'Iowan Old Style',Georgia,serif" font-style="italic" fill="#231f18">W<tspan font-size="22" dy="8">E</tspan><tspan font-size="34" dy="-8" font-style="normal"> =</tspan></text>
<text x="179.0" y="175.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(163,98,82)">+0.03</text>
<text x="179.0" y="201.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(43,86,168)">−0.08</text>
<text x="179.0" y="227.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(138,135,128)">−0.01</text>
<text x="179.0" y="253.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(160,113,95)">+0.02</text>
<text x="179.0" y="279.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(163,98,82)">+0.03</text>
<text x="179.0" y="305.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(138,135,128)">−0.01</text>
<text x="179.0" y="331.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(157,128,108)">+0.01</text>
<text x="179.0" y="357.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(138,135,128)">−0.01</text>
<text x="179.0" y="383.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(176,39,31)">+0.07</text>
<text x="179.0" y="409.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(157,128,108)">+0.01</text>
<text x="179.0" y="435.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(43,86,168)">−0.09</text>
<text x="179.0" y="461.0" text-anchor="middle" font-size="13" fill="#998f7d">⋮</text>
<text x="179.0" y="487.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(106,119,141)">−0.03</text>
<text x="225.0" y="175.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(163,98,82)">+0.03</text>
<text x="225.0" y="201.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(43,86,168)">−0.08</text>
<text x="225.0" y="227.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(170,69,57)">+0.05</text>
<text x="225.0" y="253.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(167,84,70)">+0.04</text>
<text x="225.0" y="279.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(167,84,70)">+0.04</text>
<text x="225.0" y="305.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(43,86,168)">−0.08</text>
<text x="225.0" y="331.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(160,113,95)">+0.02</text>
<text x="225.0" y="357.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(176,39,31)">+0.08</text>
<text x="225.0" y="383.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(173,54,44)">+0.06</text>
<text x="225.0" y="409.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(75,102,155)">−0.05</text>
<text x="225.0" y="435.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(75,102,155)">−0.05</text>
<text x="225.0" y="461.0" text-anchor="middle" font-size="13" fill="#998f7d">⋮</text>
<text x="225.0" y="487.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(163,98,82)">+0.03</text>
<text x="271.0" y="175.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(138,135,128)">−0.01</text>
<text x="271.0" y="201.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(59,94,161)">−0.06</text>
<text x="271.0" y="227.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(122,127,134)">−0.02</text>
<text x="271.0" y="253.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(160,113,95)">+0.02</text>
<text x="271.0" y="279.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(163,98,82)">+0.03</text>
<text x="271.0" y="305.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(59,94,161)">−0.06</text>
<text x="271.0" y="331.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(75,102,155)">−0.05</text>
<text x="271.0" y="357.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(167,84,70)">+0.04</text>
<text x="271.0" y="383.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(173,54,44)">+0.06</text>
<text x="271.0" y="409.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(91,110,148)">−0.04</text>
<text x="271.0" y="435.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(106,119,141)">−0.03</text>
<text x="271.0" y="461.0" text-anchor="middle" font-size="13" fill="#998f7d">⋮</text>
<text x="271.0" y="487.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(106,119,141)">−0.03</text>
<text x="317.0" y="175.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(91,110,148)">−0.04</text>
<text x="317.0" y="201.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(154,143,121)">+0.00</text>
<text x="317.0" y="227.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(163,98,82)">+0.03</text>
<text x="317.0" y="253.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(176,39,31)">+0.07</text>
<text x="317.0" y="279.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(157,128,108)">+0.01</text>
<text x="317.0" y="305.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(75,102,155)">−0.05</text>
<text x="317.0" y="331.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(160,113,95)">+0.02</text>
<text x="317.0" y="357.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(176,39,31)">+0.07</text>
<text x="317.0" y="383.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(75,102,155)">−0.05</text>
<text x="317.0" y="409.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(91,110,148)">−0.04</text>
<text x="317.0" y="435.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(59,94,161)">−0.06</text>
<text x="317.0" y="461.0" text-anchor="middle" font-size="13" fill="#998f7d">⋮</text>
<text x="317.0" y="487.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(122,127,134)">−0.02</text>
<text x="363.0" y="175.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(43,86,168)">−0.07</text>
<text x="363.0" y="201.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(157,128,108)">+0.01</text>
<text x="363.0" y="227.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(154,143,121)">+0.00</text>
<text x="363.0" y="253.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(91,110,148)">−0.04</text>
<text x="363.0" y="279.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(173,54,44)">+0.06</text>
<text x="363.0" y="305.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(138,135,128)">−0.01</text>
<text x="363.0" y="331.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(160,113,95)">+0.02</text>
<text x="363.0" y="357.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(176,39,31)">+0.07</text>
<text x="363.0" y="383.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(138,135,128)">−0.01</text>
<text x="363.0" y="409.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(138,135,128)">−0.01</text>
<text x="363.0" y="435.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(43,86,168)">−0.07</text>
<text x="363.0" y="461.0" text-anchor="middle" font-size="13" fill="#998f7d">⋮</text>
<text x="363.0" y="487.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(59,94,161)">−0.06</text>
<text x="409.0" y="175.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(43,86,168)">−0.09</text>
<text x="409.0" y="201.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(106,119,141)">−0.03</text>
<text x="409.0" y="227.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(154,143,121)">+0.00</text>
<text x="409.0" y="253.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(167,84,70)">+0.04</text>
<text x="409.0" y="279.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(106,119,141)">−0.03</text>
<text x="409.0" y="305.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(170,69,57)">+0.05</text>
<text x="409.0" y="331.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(138,135,128)">−0.01</text>
<text x="409.0" y="357.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(157,128,108)">+0.01</text>
<text x="409.0" y="383.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(122,127,134)">−0.02</text>
<text x="409.0" y="409.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(160,113,95)">+0.02</text>
<text x="409.0" y="435.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(176,39,31)">+0.07</text>
<text x="409.0" y="461.0" text-anchor="middle" font-size="13" fill="#998f7d">⋮</text>
<text x="409.0" y="487.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(154,143,121)">+0.00</text>
<text x="455.0" y="175.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(160,113,95)">+0.02</text>
<text x="455.0" y="201.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(75,102,155)">−0.05</text>
<text x="455.0" y="227.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(157,128,108)">+0.01</text>
<text x="455.0" y="253.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(173,54,44)">+0.06</text>
<text x="455.0" y="279.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(138,135,128)">−0.01</text>
<text x="455.0" y="305.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(122,127,134)">−0.02</text>
<text x="455.0" y="331.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(176,39,31)">+0.07</text>
<text x="455.0" y="357.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(157,128,108)">+0.01</text>
<text x="455.0" y="383.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(59,94,161)">−0.06</text>
<text x="455.0" y="409.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(170,69,57)">+0.05</text>
<text x="455.0" y="435.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(163,98,82)">+0.03</text>
<text x="455.0" y="461.0" text-anchor="middle" font-size="13" fill="#998f7d">⋮</text>
<text x="455.0" y="487.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(167,84,70)">+0.04</text>
<text x="501.0" y="175.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(160,113,95)">+0.02</text>
<text x="501.0" y="201.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(167,84,70)">+0.04</text>
<text x="501.0" y="227.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(157,128,108)">+0.01</text>
<text x="501.0" y="253.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(106,119,141)">−0.03</text>
<text x="501.0" y="279.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(154,143,121)">+0.00</text>
<text x="501.0" y="305.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(160,113,95)">+0.02</text>
<text x="501.0" y="331.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(75,102,155)">−0.05</text>
<text x="501.0" y="357.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(160,113,95)">+0.02</text>
<text x="501.0" y="383.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(170,69,57)">+0.05</text>
<text x="501.0" y="409.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(170,69,57)">+0.05</text>
<text x="501.0" y="435.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(157,128,108)">+0.01</text>
<text x="501.0" y="461.0" text-anchor="middle" font-size="13" fill="#998f7d">⋮</text>
<text x="501.0" y="487.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(75,102,155)">−0.05</text>
<text x="547.0" y="175.0" text-anchor="middle" font-size="12" fill="#998f7d">⋯</text>
<text x="547.0" y="201.0" text-anchor="middle" font-size="12" fill="#998f7d">⋯</text>
<text x="547.0" y="227.0" text-anchor="middle" font-size="12" fill="#998f7d">⋯</text>
<text x="547.0" y="253.0" text-anchor="middle" font-size="12" fill="#998f7d">⋯</text>
<text x="547.0" y="279.0" text-anchor="middle" font-size="12" fill="#998f7d">⋯</text>
<text x="547.0" y="305.0" text-anchor="middle" font-size="12" fill="#998f7d">⋯</text>
<text x="547.0" y="331.0" text-anchor="middle" font-size="12" fill="#998f7d">⋯</text>
<text x="547.0" y="357.0" text-anchor="middle" font-size="12" fill="#998f7d">⋯</text>
<text x="547.0" y="383.0" text-anchor="middle" font-size="12" fill="#998f7d">⋯</text>
<text x="547.0" y="409.0" text-anchor="middle" font-size="12" fill="#998f7d">⋯</text>
<text x="547.0" y="435.0" text-anchor="middle" font-size="12" fill="#998f7d">⋯</text>
<text x="547.0" y="461.0" text-anchor="middle" font-size="13" fill="#998f7d">⋮</text>
<text x="547.0" y="487.0" text-anchor="middle" font-size="12" fill="#998f7d">⋯</text>
<text x="593.0" y="175.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(160,113,95)">+0.02</text>
<text x="593.0" y="201.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(157,128,108)">+0.01</text>
<text x="593.0" y="227.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(138,135,128)">−0.01</text>
<text x="593.0" y="253.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(106,119,141)">−0.03</text>
<text x="593.0" y="279.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(91,110,148)">−0.04</text>
<text x="593.0" y="305.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(154,143,121)">+0.00</text>
<text x="593.0" y="331.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(157,128,108)">+0.01</text>
<text x="593.0" y="357.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(157,128,108)">+0.01</text>
<text x="593.0" y="383.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(122,127,134)">−0.02</text>
<text x="593.0" y="409.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(173,54,44)">+0.06</text>
<text x="593.0" y="435.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(163,98,82)">+0.03</text>
<text x="593.0" y="461.0" text-anchor="middle" font-size="13" fill="#998f7d">⋮</text>
<text x="593.0" y="487.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(160,113,95)">+0.02</text>
<text x="639.0" y="175.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(170,69,57)">+0.05</text>
<text x="639.0" y="201.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(91,110,148)">−0.04</text>
<text x="639.0" y="227.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(106,119,141)">−0.03</text>
<text x="639.0" y="253.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(167,84,70)">+0.04</text>
<text x="639.0" y="279.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(167,84,70)">+0.04</text>
<text x="639.0" y="305.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(59,94,161)">−0.06</text>
<text x="639.0" y="331.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(163,98,82)">+0.03</text>
<text x="639.0" y="357.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(167,84,70)">+0.04</text>
<text x="639.0" y="383.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(176,39,31)">+0.10</text>
<text x="639.0" y="409.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(122,127,134)">−0.02</text>
<text x="639.0" y="435.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(163,98,82)">+0.03</text>
<text x="639.0" y="461.0" text-anchor="middle" font-size="13" fill="#998f7d">⋮</text>
<text x="639.0" y="487.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(173,54,44)">+0.06</text>
<text x="685.0" y="175.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(138,135,128)">−0.01</text>
<text x="685.0" y="201.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(176,39,31)">+0.07</text>
<text x="685.0" y="227.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(163,98,82)">+0.03</text>
<text x="685.0" y="253.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(59,94,161)">−0.06</text>
<text x="685.0" y="279.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(91,110,148)">−0.04</text>
<text x="685.0" y="305.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(154,143,121)">+0.00</text>
<text x="685.0" y="331.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(167,84,70)">+0.04</text>
<text x="685.0" y="357.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(170,69,57)">+0.05</text>
<text x="685.0" y="383.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(138,135,128)">−0.01</text>
<text x="685.0" y="409.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(154,143,121)">+0.00</text>
<text x="685.0" y="435.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(163,98,82)">+0.03</text>
<text x="685.0" y="461.0" text-anchor="middle" font-size="13" fill="#998f7d">⋮</text>
<text x="685.0" y="487.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(106,119,141)">−0.03</text>
<text x="731.0" y="175.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(176,39,31)">+0.08</text>
<text x="731.0" y="201.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(173,54,44)">+0.06</text>
<text x="731.0" y="227.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(167,84,70)">+0.04</text>
<text x="731.0" y="253.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(154,143,121)">+0.00</text>
<text x="731.0" y="279.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(106,119,141)">−0.03</text>
<text x="731.0" y="305.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(138,135,128)">−0.01</text>
<text x="731.0" y="331.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(167,84,70)">+0.04</text>
<text x="731.0" y="357.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(163,98,82)">+0.03</text>
<text x="731.0" y="383.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(160,113,95)">+0.02</text>
<text x="731.0" y="409.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(75,102,155)">−0.05</text>
<text x="731.0" y="435.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(138,135,128)">−0.01</text>
<text x="731.0" y="461.0" text-anchor="middle" font-size="13" fill="#998f7d">⋮</text>
<text x="731.0" y="487.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(170,69,57)">+0.05</text>
<text x="777.0" y="175.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(176,39,31)">+0.08</text>
<text x="777.0" y="201.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(170,69,57)">+0.05</text>
<text x="777.0" y="227.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(122,127,134)">−0.02</text>
<text x="777.0" y="253.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(75,102,155)">−0.05</text>
<text x="777.0" y="279.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(138,135,128)">−0.01</text>
<text x="777.0" y="305.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(138,135,128)">−0.01</text>
<text x="777.0" y="331.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(160,113,95)">+0.02</text>
<text x="777.0" y="357.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(160,113,95)">+0.02</text>
<text x="777.0" y="383.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(91,110,148)">−0.04</text>
<text x="777.0" y="409.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(160,113,95)">+0.02</text>
<text x="777.0" y="435.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(167,84,70)">+0.04</text>
<text x="777.0" y="461.0" text-anchor="middle" font-size="13" fill="#998f7d">⋮</text>
<text x="777.0" y="487.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(157,128,108)">+0.01</text>
<text x="823.0" y="175.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(176,39,31)">+0.08</text>
<text x="823.0" y="201.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(176,39,31)">+0.08</text>
<text x="823.0" y="227.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(154,143,121)">+0.00</text>
<text x="823.0" y="253.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(59,94,161)">−0.06</text>
<text x="823.0" y="279.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(122,127,134)">−0.02</text>
<text x="823.0" y="305.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(106,119,141)">−0.03</text>
<text x="823.0" y="331.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(138,135,128)">−0.01</text>
<text x="823.0" y="357.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(163,98,82)">+0.03</text>
<text x="823.0" y="383.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(154,143,121)">+0.00</text>
<text x="823.0" y="409.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(160,113,95)">+0.02</text>
<text x="823.0" y="435.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(154,143,121)">+0.00</text>
<text x="823.0" y="461.0" text-anchor="middle" font-size="13" fill="#998f7d">⋮</text>
<text x="823.0" y="487.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(122,127,134)">−0.02</text>
<text x="869.0" y="175.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(106,119,141)">−0.03</text>
<text x="869.0" y="201.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(154,143,121)">+0.00</text>
<text x="869.0" y="227.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(163,98,82)">+0.03</text>
<text x="869.0" y="253.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(106,119,141)">−0.03</text>
<text x="869.0" y="279.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(122,127,134)">−0.02</text>
<text x="869.0" y="305.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(106,119,141)">−0.03</text>
<text x="869.0" y="331.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(163,98,82)">+0.03</text>
<text x="869.0" y="357.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(163,98,82)">+0.03</text>
<text x="869.0" y="383.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(43,86,168)">−0.08</text>
<text x="869.0" y="409.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(157,128,108)">+0.01</text>
<text x="869.0" y="435.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(167,84,70)">+0.04</text>
<text x="869.0" y="461.0" text-anchor="middle" font-size="13" fill="#998f7d">⋮</text>
<text x="869.0" y="487.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(122,127,134)">−0.02</text>
<text x="915.0" y="175.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(167,84,70)">+0.04</text>
<text x="915.0" y="201.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(91,110,148)">−0.04</text>
<text x="915.0" y="227.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(160,113,95)">+0.02</text>
<text x="915.0" y="253.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(122,127,134)">−0.02</text>
<text x="915.0" y="279.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(163,98,82)">+0.03</text>
<text x="915.0" y="305.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(154,143,121)">+0.00</text>
<text x="915.0" y="331.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(122,127,134)">−0.02</text>
<text x="915.0" y="357.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(163,98,82)">+0.03</text>
<text x="915.0" y="383.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(163,98,82)">+0.03</text>
<text x="915.0" y="409.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(157,128,108)">+0.01</text>
<text x="915.0" y="435.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(122,127,134)">−0.02</text>
<text x="915.0" y="461.0" text-anchor="middle" font-size="13" fill="#998f7d">⋮</text>
<text x="915.0" y="487.0" text-anchor="middle" font-size="11.5" font-family="ui-monospace,Menlo,monospace" fill="rgb(160,113,95)">+0.02</text>
<path d="M 954 158 q 8 0 8 10 L 962 317.0 q 0 10 8 10 q -8 0 -8 10 L 962 486 q 0 10 -8 10" fill="none" stroke="#998f7d" stroke-width="1.2"/>
<text x="976" y="323.0" font-size="12" font-family="Charter,'Iowan Old Style',Georgia,serif" fill="#6e6557">384</text>
<text x="976" y="338.0" font-size="12" font-family="Charter,'Iowan Old Style',Georgia,serif" fill="#6e6557">dims</text>
<text x="547.0" y="540" text-anchor="middle" font-size="23" font-family="Charter,'Iowan Old Style',Georgia,serif" fill="#231f18">Embedding matrix</text>
<text x="156" y="558" font-size="10.5" font-family="Charter,'Iowan Old Style',Georgia,serif" fill="#6e6557">each cell is one real learned number:</text>
<text x="368" y="558" font-size="11" font-family="ui-monospace,Menlo,monospace" fill="rgb(176,39,31)">+ red</text>
<text x="424" y="558" font-size="10.5" font-family="Charter,'Iowan Old Style',Georgia,serif" fill="#6e6557">stronger positive,</text>
<text x="528" y="558" font-size="11" font-family="ui-monospace,Menlo,monospace" fill="rgb(43,86,168)">− blue</text>
<text x="584" y="558" font-size="10.5" font-family="Charter,'Iowan Old Style',Georgia,serif" fill="#6e6557">stronger negative</text>
</svg>'''
...
"""),
  ("diagram", WE_MATRIX_SVG,
   ...
   "~8,160). Each column also carries its real <strong>token id</strong> (scrambled: the columns are "
