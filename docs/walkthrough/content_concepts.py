...
TOKENIZE_SVG = r'''<svg viewBox="0 0 720 312" role="img" aria-label="Tokenization two ways: the sentence Once upon a time as 16 per-character numbers (notebook 01), then as 4 BPE word-chunks with their real token ids (notebook 02).">
...
"""),
  ("diagram", TOKENIZE_SVG,
   "The same sentence, tokenized two ways — with the real numbers from Part 1's notebooks: "
   "character IDs from notebook 01's vocabulary, BPE chunk IDs from notebook 02's."),
  ("prose", r"""
