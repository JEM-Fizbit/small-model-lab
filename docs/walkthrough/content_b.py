...
it lets us <em>measure</em> correctness later by simple comparison — no human grading the bulk of it.</p>
"""),
...
the schema. So every answer comes back already valid and parseable — no JSON wrangling.</li>
...
{
 "id": "arc", "num": "10", "title": "The arc, closed — and running it yourself",
 "blocks": [
  ("prose", r"""
